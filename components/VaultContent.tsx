  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-neutral-600 dark:text-neutral-400">
        Vault is a modern, full-featured personal finance management platform
        designed to help users effectively track their transactions, manage
        their budgets, and gain intelligent insights into their financial
        habits. The platform blends traditional financial tools with
        cutting-edge AI and interactive UI features to create a seamless and
        smart money-management experience.
      </p>

      <h2 className="text-2xl mt-5 underline">Core Functionality</h2>

      <h3 className="text-xl text-neutral-700 dark:text-neutral-200 mt-2">
        Transaction Management
      </h3>
      <ul className="list-disc list-inside pl-2 text-neutral-600 dark:text-neutral-400">
        ...
        <motion.div whileHover={{ scale: 1.05, y: -1 }} whileTap={{ scale: 0.95, y: 0 }}>
          <Link
            className="px-3 py-1 rounded-[4px] 
              bg-neutral-200/60 dark:bg-white/20 
              backdrop-blur-md 
              border border-neutral-300 dark:border-white/30 
              shadow-md dark:shadow-lg 
              text-neutral-800 dark:text-white 
              font-semibold 
              hover:bg-neutral-300/60 dark:hover:bg-white/30 
